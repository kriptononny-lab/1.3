...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center pt-[76px] overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 z-0 bg-gradient-to-b from-[#0a0e1f] via-[#1a1535] to-[#8a3a1f]">
        <div
        ...
        />
        <div className="absolute bottom-0 left-0 right-0 h-[200px] bg-gradient-to-t from-[#141414] to-transparent z-[2]" />
      </div>

      {/* Skyline */}
      <div className="absolute bottom-0 left-0 right-0 z-[1] pointer-events-none h-[60%]">
        <svg viewBox="0 0 1920 600" preserveAspectRatio="xMidYMax slice" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
          <g fill="#1a0f1f">
          ...
          <g fill="#E8A825" opacity="0.85">
            <circle cx="520" cy="370" r="2" /><circle cx="540" cy="400" r="2" /><circle cx="560" cy="430" r="2" />
            <circle cx="630" cy="340" r="2" /><circle cx="650" cy="380" r="2" />
            <circle cx="720" cy="380" r="2" /><circle cx="750" cy="420" r="2" />
            <circle cx="840" cy="320" r="2" /><circle cx="860" cy="370" r="2" />
            <circle cx="935" cy="240" r="1.5" /><circle cx="955" cy="240" r="1.5" /><circle cx="975" cy="240" r="1.5" />
            <circle cx="935" cy="320" r="1.5" /><circle cx="955" cy="320" r="1.5" /><circle cx="975" cy="320" r="1.5" />
            <circle cx="935" cy="400" r="1.5" /><circle cx="955" cy="400" r="1.5" /><circle cx="975" cy="400" r="1.5" />
            <circle cx="1075" cy="200" r="2" /><circle cx="1075" cy="290" r="2" /><circle cx="1075" cy="390" r="2" />
            <circle cx="1120" cy="350" r="2" /><circle cx="1220" cy="320" r="2" />
            <circle cx="1330" cy="370" r="2" /><circle cx="1420" cy="340" r="2" /><circle cx="1450" cy="390" r="2" />
          </g>
        </svg>
      </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-[3] grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full">
        <div>
          <div className="inline-flex items-center gap-3 text-xs font-semibold tracking-[0.2em] uppercase text-[#E8A825] mb-5">
            <span className="w-8 h-[2px] bg-[#E8A825] block" />
            {t('badge')}
          </div>
          ...
          <h1 className="font-heading font-semibold uppercase tracking-wider text-[clamp(2.4rem,5vw,3.6rem)] leading-[1.15] mb-5">
            {t('title1')}<br />
            {t('title2')}{' '}
            <span className="text-[#E8A825]">{t('titleHighlight')}</span>{' '}
            {t('flag')}
          </h1>

          <p className="text-lg text-gray-400 max-w-[480px] mb-9 leading-relaxed">
            {t('description')}
          </p>
          ...
          <div className="flex gap-4 flex-wrap">
            <button
              ...
              className="px-7 py-3 bg-[#E8A825] text-black font-heading font-semibold text-sm uppercase tracking-wider rounded-lg hover:bg-[#F5C542] hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(232,168,37,0.4)] transition-all duration-300 relative overflow-hidden group"
            >
            ...
            <a href="#services" className="px-7 py-3 bg-transparent text-[#E8A825] border-2 border-[#E8A825] font-heading font-semibold text-sm uppercase tracking-wider rounded-lg hover:bg-[#E8A825] hover:text-black transition-all duration-300">
              {t('servicesButton')}
            </a>
          </div>
        </div>
        ...
        <div className="hidden lg:block">
          <svg viewBox="0 0 600 400" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-[540px] drop-shadow-[0_30px_60px_rgba(0,0,0,0.5)]">
            <defs>
              <linearGradient id="vb" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#fff" /><stop offset="60%" stopColor="#e8e8e8" /><stop offset="100%" stopColor="#b8b8b8" /></linearGradient>
              <linearGradient id="vc" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#f5f5f5" /><stop offset="100%" stopColor="#a8a8a8" /></linearGradient>
              <linearGradient id="ws" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#1a3055" /><stop offset="100%" stopColor="#0a1525" /></linearGradient>
              <radialGradient id="hl" cx="0.5" cy="0.5" r="0.5"><stop offset="0%" stopColor="#fff8d0" /><stop offset="100%" stopColor="#E8A825" stopOpacity="0" /></radialGradient>
            </defs>
            ...
            <g style={{ animation: 'vanBob 3.5s ease-in-out infinite' }}>
              ...
              {/* Lion logo on van side */}
              <image href="/logo.png" x="200" y="155" width="100" height="100" opacity="0.95" />
              {/* Cabin */}
              ...
              <line x1="513" y1="275" x2="529" y2="275" stroke="#555" strokeWidth="0.6" />
              <line x1="513" y1="280" x2="529" y2="280" stroke="#555" strokeWidth="0.6" />
              <line x1="513" y1="285" x2="529" y2="285" stroke="#555" strokeWidth="0.6" />
              {/* Bumper */}
            ...
            <g>
              ...
              <g>
                ...
                <line x1="145" y1="305" x2="175" y2="335" stroke="#555" strokeWidth="1.5" />
                <line x1="175" y1="305" x2="145" y2="335" stroke="#555" strokeWidth="1.5" />
            ...
            <g>
              ...
              <g>
                ...
                <line x1="435" y1="305" x2="465" y2="335" stroke="#555" strokeWidth="1.5" />
                <line x1="465" y1="305" x2="435" y2="335" stroke="#555" strokeWidth="1.5" />
